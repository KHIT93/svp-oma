...
SECRET_KEY = '@%7s*19=dadf*yregdx6o5*5&bll&vp(5qq9$v%1^)%yu&5#(o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['10.135.17.158']
...
MIDDLEWARE = [
    ...
    'appcore.middleware.RequestMiddleware',
]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, "logs", "om.log"),
        },
    },
    'loggers': {
        'django': {
